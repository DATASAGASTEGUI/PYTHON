...
class VentanaPython(QMainWindow):# HERECIA 
      ...
      def personalizarComponentes(self):
          ...
          self.botCalculo = QPushButton("CALCULAR", self.pnlPrincipal)
          self.botCalculo.setFont(QFont("Courier New", 8))
          self.botCalculo.setStyleSheet("background-color: black; color: white;")
          self.botCalculo.setGeometry(110, 220, 80, 20)
          self.botCalculo.clicked.connect(self.botCalculoClic)
          ...
          self.botReiniciar.setGeometry(200, 220, 80, 20)
          self.botReiniciar.clicked.connect(self.botReiniciarClic)

          self.botSalir = QPushButton("SALIR", self.pnlPrincipal)
          self.botSalir.setFont(QFont("Courier New", 8))
          self.botSalir.setStyleSheet("background-color: black; color: white;")
          self.botSalir.setGeometry(290, 220, 80, 20)
          self.botSalir.clicked.connect(self.botSalirClic)
